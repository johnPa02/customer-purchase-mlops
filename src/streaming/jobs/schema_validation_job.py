...
class SchemaValidationJob(FlinkJob):
    def __init__(self):
        self.jars_path = f"{os.getcwd()}/connectors/config/jars/"
        self.input_topics = ["tracking.raw_user_behavior"]
        self.group_id = "flink-group"
        self.valid_topic = "tracking.user_behavior.validated"
        self.invalid_topic = "tracking.user_behavior.invalid"
